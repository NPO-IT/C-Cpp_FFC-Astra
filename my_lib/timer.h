...
#define PREAPARE_TIMER_PTR\
	Timer::Register(0,new Timer(TIMER_0));\
	Timer::Register(1,new Timer(TIMER_1));\
	Timer::Register(2,new Timer(TIMER_2));\
	Timer::Register(3,new Timer(TIMER_3));
